...
# Whats is Ozura ?
Ozura is a powerfull toolkit for attack http services and IP, Ozura use the http/s protocol, http is better for bypass firewall of yours zombies, zombies make request every 30 seconds on Ozura Server, and the zombies make http/syn/udp request every seconds to the target
